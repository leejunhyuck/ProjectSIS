...
public class ShopUploadController {
	...
	public ResponseEntity<String> deleteFile(String fileName, String type){
		...
		try {
			file = new File("c:\\upload\\shop\\"+ URLDecoder.decode(fileName,"UTF-8"));
			file.delete();
	...
	public ResponseEntity<byte[]> getImage(String fileName){
		...
		File file = new File("c:\\upload\\shop\\"+fileName);
		File watermarkImageFile = new File("c:\\upload\\logo.png");
		File changeFile = new File("c:\\upload\\shop\\"+fileName);
	...
	public ResponseEntity<List<ShopImgVO>> upload(MultipartFile[] uploadFile) {

		List<ShopImgVO> list = new ArrayList<>();
		String uploadFolder = "C://Upload//shop";
		...
		for (MultipartFile multipartFile : uploadFile) {
			...
			ShopImgVO ShopImgvo = new ShopImgVO();
			...
			ShopImgvo.setFileName(uploadFileName);
			...
			try {
				...
				ShopImgvo.setUuid(uuid.toString());
				ShopImgvo.setUploadPath(uploadFolderPath);
