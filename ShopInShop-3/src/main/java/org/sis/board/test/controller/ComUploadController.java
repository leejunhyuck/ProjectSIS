...
public class ComUploadController {
	...
	public ResponseEntity<String> deleteFile(String fileName, String type){
		...
		try {
			file = new File("c:\\upload\\com\\"+ URLDecoder.decode(fileName,"UTF-8"));
			file.delete();
	...
	public ResponseEntity<byte[]> getImage(String fileName){
		...
		File file = new File("c:\\upload\\com\\"+fileName);
		File watermarkImageFile = new File("c:\\upload\\logo.png");
		File changeFile = new File("c:\\upload\\com\\"+fileName);
	...
	public ResponseEntity<List<ComAttachVO>> upload(MultipartFile[] uploadFile) {

		List<ComAttachVO> list = new ArrayList<>();
		String uploadFolder = "C://Upload//com";
		...
		for (MultipartFile multipartFile : uploadFile) {
			...
			ComAttachVO comAttachVO = new ComAttachVO();
			...
			comAttachVO.setFileName(uploadFileName);
			...
			try {
				...
				comAttachVO.setUuid(uuid.toString());
				comAttachVO.setUploadPath(uploadFolderPath);
				comAttachVO.setImage(true);
				
				

				list.add(comAttachVO);
			} catch (Exception e) {
				e.printStackTrace();
			} // end catch
		} // end for
